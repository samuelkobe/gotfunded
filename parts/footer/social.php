<div class="flex flex-row justify-center w-full md:w-1/4 lg:w-1/8 pb-8 md:pb-0 order-1 md:order-2">
    <?php if ( have_rows( 'social_media', 'option' ) ) : ?>

        <div class="flex flex-row w-2/3 sm:w-1/2 md:w-full h-full items-end justify-between md:justify-end md:space-x-4 lg:space-x-0 lg:justify-between">
