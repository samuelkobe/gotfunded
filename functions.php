...
add_action( 'acf/init', 'register_how_block' );
function register_how_block() {
	if ( function_exists( 'acf_register_block_type' ) ) {
		acf_register_block_type( array(
			'name' 					=> 'How',
			...
			'mode'					=> 'auto',
			'align'				=> 'wide',
			'render_template'		=> 'parts/blocks/how.php',
		));
	}
}

add_action( 'acf/init', 'register_value_points_block' );
function register_value_points_block() {
	if ( function_exists( 'acf_register_block_type' ) ) {
		acf_register_block_type( array(
			'name' 					=> 'Value Add Points',
			'title' 				=> __( 'Value Add Points' ),
			'description' 			=> __( 'Value Add Points block.' ),
			'category' 				=> 'formatting',
			'icon'					=> 'layout',
			'keywords'				=> array( 'value points', 'text', 'content' ),
			'post_types'			=> array( 'post', 'page' ),
			'mode'					=> 'auto',
			'align'				=> 'wide',
			'render_template'		=> 'parts/blocks/value-add-points.php',
		));
	}
}

add_action( 'acf/init', 'register_value_connection_block' );
function register_value_connection_block() {
	if ( function_exists( 'acf_register_block_type' ) ) {
		acf_register_block_type( array(
			'name' 					=> 'Value Add Connection',
			'title' 				=> __( 'Value Add Connection' ),
			'description' 			=> __( 'Value Add Conneciton block.' ),
			'category' 				=> 'formatting',
			'icon'					=> 'layout',
			'keywords'				=> array( 'value connection', 'text', 'content' ),
			'post_types'			=> array( 'post', 'page' ),
			'mode'					=> 'auto',
			'align'				=> 'wide',
			'render_template'		=> 'parts/blocks/value-add-connection.php',
		));
	}
}

add_action( 'acf/init', 'register_pricing_block' );
function register_pricing_block() {
	if ( function_exists( 'acf_register_block_type' ) ) {
		acf_register_block_type( array(
			...
			'mode'					=> 'auto',
			'align'				=> 'wide',
			'render_template'		=> 'parts/blocks/pricing.php',
		));
	}
}
